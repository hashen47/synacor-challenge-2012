...
class VirtualMachine():
    ...
    def op_out(self):
        ...
        if self.val(a) == 10:
            ...
            # print("a:", a, ", val:", self.val(a), ", ch:", chr(self.val(a)))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--path', dest='path', default='challenge.bin', type=str, help='The path to the input file to run in the virtual machine.')
